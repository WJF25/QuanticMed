...
class Customers(db.Model):
    ...
    def check_email(self, key, value):
        ...
        if not re.match(pattern, value):
            raise EmailError(
                {'erro': 'E-mail inválido. Formato válido: usuario@email.com'})
        return value
    ...
    def check_telephone(self, key, value):
        ...
        if not re.match(pattern, value) and value != '':
            raise NumericError(
                {'erro': 'Telefone residencial inválido. Formato válido: 10 dígitos numéricos.'})
        return value
    ...
    def check_cpf(self, key, value):
        ...
        if not re.match(pattern, value):
            raise NumericError(
                {'erro': 'Cpf inválido. Formato válido: 11 dígitos numéricos.'})
        return value
    ...
    def check_cellphone(self, key, value):
        ...
        if not re.match(pattern, value) and value != '':
            raise NumericError(
                {'erro': 'Telefone celular inválido. Formato válido: 10-11 dígitos numéricos.'})
        return value
    ...
    def check_zipcode(self, key, value):
        ...
        if not re.match(pattern, value) and value != '':
            raise NumericError(
                {'erro': 'CEP inválido. Formato válido: 8 dígitos numéricos.'})
        return value
    ...
    def check_address(self, key, value):
        ...
        if not re.match(pattern, value):
            raise NumericError(
                {'erro': 'Número residencial inválido. Formato válido: 1-9 dígitos numéricos.'})
        return value
    ...
    def check_rg(self, key, value):
        ...
        if not re.match(pattern, value):
            raise NumericError(
                {'erro': 'Número de RG inválido. Formato válido: 6-15 dígitos numéricos.'})
        return value
    ...
    def check_telephone(self, key, value):
        ...
        if not re.match(pattern, value):
            raise NumericError(
                {'erro': 'Data de nascimento inválida. Formato válido: 00/00/0000.'})
